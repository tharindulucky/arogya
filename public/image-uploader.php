...
if(isset($_POST['disease_rec_id'])){
    $disease_rec_id = filter($_POST['disease_rec_id']);
}


$ds = DIRECTORY_SEPARATOR; 
 
$storeFolder = "uploads/{$patient['id']}/diseases/{$disease_rec_id}";  
...
if (!empty($_FILES)) {
    ...
    move_uploaded_file($tempFile,$targetFile);
        ...
        if($resultr){
            ...
            $query2 = "INSERT INTO diseases_rec_images(";
            $query2 .= "disease_rec_id, image_id";
            $query2 .= ") VALUES(";
            $query2 .= "'{$disease_rec_id}', {$image_id}";
            $query2 .= ");";
