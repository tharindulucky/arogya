    ...
    <div id="wrapper">
      <?php require_once('nav.php'); ?>
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><?php echo $patient['name'] ?> | 
                        <span style="font-size: 20px"> <?php echo $patient['age'] ?> Years </span> </h2>
                        ...
                        <div class="panel panel-default">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                       <tbody>
                                        <tr class="warning">
                                            <td colspan="8"  style="border-right: 2px solid;"><small>Right Upper</small></td>
                                                    <td colspan="8" style="text-align:right; border-left: 2px solid;"><small>Left Upper</small></td>
                                         </tr>
                                         <tr class="success">
                                            ...
                                            <tr class="info">
                                                ...
                                                <td>
                                                    ...
                                                    <tr class="warning">
                                                            <td colspan="8" style="border-right: 2px solid;"><small>Right Lower</small></td>
						...
						<div class="panel panel-default">
							...
							<div class="panel panel-success">
								<div class="panel-heading">
									...
									<button title="Add Disease Log" type="button" class="btn btn-success btn-circle" data-toggle="modal" data-target="#add_disease_log"><i class="fa fa-plus"></i></button>
								</div>
								<div class="panel-body">
												...
												<?php
                                                                                                $result = get_disease_rec_by_patient_id($patient['id']);
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td><button title="Upload images" class="open_uploader_disease_rec btn btn-success btn-circle" type="button" data-disease_rec_id="<?php echo $diseases_rec_set['id']; ?>"  data-toggle="modal" data-target="#image_gallery" ><i class="fa fa-camera"></i></button></td>
                                                                                                        <td><?php echo $diseases_rec_set['note']; ?></td>
                                                                                                        <td class="center">
                                                                                                            <a title="Edit Disease Log" href="edit-disease-rec.php?id=<?php echo $diseases_rec_set['id']; ?>&p_id=<?php echo $patient['id']; ?>" id="ttt" style="align:right" class="btn btn-info btn-circle" ><i class="fa fa-pencil"></i></a>
                                                                                                            <a title="Delete Disese Log" onclick="return confirm('Are you sure ?')" href="delete-disease-rec.php?id=<?php echo $diseases_rec_set['id']; ?>&p_id=<?php echo $patient['id']; ?>" class="btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <?php
                                                                                                    }
                ...
                <!-- /.col-lg-12 -->
						...
						<div class="panel panel-default">
							...
							<div class="panel panel-warning">
								<div class="panel-heading">
									Treatments
                                                                        <button title="Add Treatment Log" type="button" class="btn btn-warning btn-circle" data-toggle="modal"  data-target="#add_treatment_log"><i class="fa fa-plus"></i></button>
								</div>
								<div class="panel-body">
											...
											<tbody>
												<?php
                                                                                                ...
                                                                                                <tr style="background-color: <?php echo $treatment_rec_set['completed'] == '1' ? '#d6e9c6' : '#fcf8e3' ?>">
                                                                                                        ...
                                                                                                        <td><button title="Upload images" type="button" class="btn btn-warning btn-circle open_uploader_treatment_rec" data-toggle="modal" data-treatment_rec_id="<?php echo $treatment_rec_set['id']; ?>" data-target="#image_gallery_treatment"><i class="fa fa-camera"></i></button></td>
                                                                                                        <td><?php echo $treatment_rec_set['note']; ?></td>
                                       ...
                                       <tbody>
                                        <tr class="warning">
                                         ...
                                         <tr class="success">
                                                ...
                                                <td style="background-color:transparent;"></td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="RUE" id="RUE"   name="teeth_group[]" type="checkbox">E</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="RUD" id="RUD"    name="teeth_group[]" type="checkbox">D</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="RUC" id="RUC"  name="teeth_group[]" type="checkbox">C</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="RUB" id="RUB"   name="teeth_group[]" type="checkbox">B</label>
                                                </td>
                                                <td style="border-right: 2px solid;">
                                                        <label class="checkbox-inline"><input value="RUA" id="RUA"  name="teeth_group[]" type="checkbox">A</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="LUA" id="LUA"  name="teeth_group[]" type="checkbox">A</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="LUB" id="LUB"  name="teeth_group[]" type="checkbox">B</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="LUC" id="LUC"  name="teeth_group[]" type="checkbox">C</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="LUD" id="LUD"  name="teeth_group[]" type="checkbox">D</label>
                                                </td>
                                                <td>
                                                        <label class="checkbox-inline"><input value="LUE" id="LUE"  name="teeth_group[]" type="checkbox">E</label>
                                                </td>
                                                <td style="background-color:transparent;"></td>
                                                <td style="background-color:transparent;"></td>
                                                <td style="background-color:transparent;"></td>
                                            ...
                                            <tr class="info">
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="RU8" id="RU8"  name="teeth_group[]" type="checkbox">8</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU7" id="RU7"  name="teeth_group[]" type="checkbox">7</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU6" id="RU6"  name="teeth_group[]" type="checkbox">6</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU5" id="RU5"  name="teeth_group[]" type="checkbox">5</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU4" id="RU4"  name="teeth_group[]" type="checkbox">4</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU3" id="RU3"  name="teeth_group[]" type="checkbox">3</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU2" id="RU2"  name="teeth_group[]" type="checkbox">2</label>
                                                </td>
                                                <td style="border-right: 2px solid; border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input  value="RU1" id="RU1"  name="teeth_group[]" type="checkbox">1</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU1" id="LU1"  name="teeth_group[]" type="checkbox">1</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU2" id="LU2"  name="teeth_group[]" type="checkbox">2</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU3" id="LU3"  name="teeth_group[]" type="checkbox">3</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU4" id="LU4"  name="teeth_group[]" type="checkbox">4</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU5" id="LU5"  name="teeth_group[]" type="checkbox">5</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU6" id="LU6"  name="teeth_group[]" type="checkbox">6</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU7" id="LU7"  name="teeth_group[]" type="checkbox">7</label>
                                                </td>
                                                <td style="border-bottom: 2px solid;">
                                                    <label class="checkbox-inline"><input value="LU8" id="LU8"  name="teeth_group[]" type="checkbox">8</label>
                                                </td>
                                            </tr>

                                            <tr class="info">
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL8" id="RL8"  name="teeth_group[]" type="checkbox">8</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL7" id="RL7"  name="teeth_group[]" type="checkbox">7</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL6" id="RL6"  name="teeth_group[]" type="checkbox">6</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL5" id="RL5"  name="teeth_group[]" type="checkbox">5</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL4" id="RL4"  name="teeth_group[]" type="checkbox">4</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL3" id="RL3"  name="teeth_group[]" type="checkbox">3</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="RL2" id="RL2"  name="teeth_group[]" type="checkbox">2</label>
                                                </td>
                                                <td style="border-right: 2px solid;">
                                                    <label class="checkbox-inline"><input value="RL1" id="RL1"  name="teeth_group[]" type="checkbox">1</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL1" id="LL1"  name="teeth_group[]" type="checkbox">1</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL2" id="LL2"  name="teeth_group[]" type="checkbox">2</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL3" id="LL3"  name="teeth_group[]" type="checkbox">3</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL4"  id="LL4"  name="teeth_group[]" type="checkbox">4</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL5" id="LL5"  name="teeth_group[]" type="checkbox">5</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL6" id="LL6"  name="teeth_group[]" type="checkbox">6</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL7" id="LL7"  name="teeth_group[]" type="checkbox">7</label>
                                                </td>
                                                <td>
                                                    <label class="checkbox-inline"><input value="LL8" id="LL8"  name="teeth_group[]" type="checkbox">8</label>
                                                </td>
                                            </tr>
                                                    ...
                                                    <tr class="success">
                                                        ...
                                                        <td style="background-color:transparent;"></td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="RLE" id="RLE"  name="teeth_group[]" type="checkbox">E</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="RLD" id="RLD"  name="teeth_group[]" type="checkbox">D</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="RLC" id="RLC"  name="teeth_group[]" type="checkbox">C</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="RLB" id="RLB"  name="teeth_group[]" type="checkbox">B</label>
                                                        </td>
                                                        <td style="border-right: 2px solid;">
                                                            <label class="checkbox-inline"><input value="RLA" id="RLA"  name="teeth_group[]" type="checkbox">A</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="LLA" id="LLA"  name="teeth_group[]" type="checkbox">A</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="LLB" id="LLB"  name="teeth_group[]" type="checkbox">B</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="LLC" id="LLC"  name="teeth_group[]" type="checkbox">C</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="LLD" id="LLD"  name="teeth_group[]" type="checkbox">D</label>
                                                        </td>
                                                        <td>
                                                            <label class="checkbox-inline"><input value="LLE" id="LLE"  name="teeth_group[]" type="checkbox">E</label>
                                                        </td>
                                                        <td style="background-color:transparent;"></td>
                                                        <td style="background-color:transparent;"></td>
                                                        <td style="background-color:transparent;"></td>
