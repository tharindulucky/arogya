...
$current_disease_log = null;
$current_patient = null;

if(isset($_GET['id'])){
    $current_disease_log = get_disease_rec_by_id($_GET['id']);
...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        $query = "UPDATE diseases_record SET ";
        $query .= "datetime = '{$date}', ";
        $query .= "condition_name = '{$condition}', ";
        $query .= "note = '{$notes}' ";
        $query .= "WHERE id = {$current_disease_log['id']} ";
        $query .= "LIMIT 1";
        ...
        $query2 .= "WHERE disease_rec_id = {$current_disease_log['id']} ";
        ...
        if($result && $result2 && isset($affected_teeth)){
            foreach ($affected_teeth as $key => $value){
                    ...
                    $query3 = "INSERT INTO tooth_diseases_rec(";
                    $query3 .= "tooth_id, disease_rec_id, patient_id ";
                    $query3 .= ") VALUES(";
                    $query3 .= "'{$value}', '{$current_disease_log['id']}', {$current_patient['id']}";
                    $query3 .= ");";
            ...
            if($result3){
                $_SESSION["message"] = "Disease Log Updated";
                redirect_to("patient.php?id={$current_patient['id']}");
            }else{
                $_SESSION["errors"] = "Disease Log not Updated ". mysqli_error($db_conx);
                redirect_to("patient.php?id={$current_patient['id']}");   
            }
...
?>
<?php get_header("Edit Disease Log");  ?>
    <div id="wrapper">
   ...
   <?php require_once('nav.php'); ?>
        ...
        <div id="page-wrapper">
             ...
             <form method="post" action="edit-disease-rec.php?id=<?php echo $current_disease_log['id'] ?>&p_id=<?php echo $current_patient['id'] ?>"> 
            
            <div class="row">
                
                <div class="col-lg-12">
                    <h2 class="page-header">Edit Disease Log</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                         ...
                                         <tr class="success">
                                                ...
                                                <td>
                                                        <label class="checkbox-inline"><input value="RUE" 
                                                             <?php
                                                             $affected_teeth = get_teeth_by_disease_rec_id($current_disease_log['id']);
                                            ...
                                            $('#datetimepicker2').datetimepicker();
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="input-group date col-sm-8"  style="padding-left: 14px" id="datetimepicker2">
                                                        <input value="<?php echo $current_disease_log['datetime'] ?>" class="form-control" type="text" name="date"><span class="input-group-addon"><span class="glyphicon-calendar glyphicon"></span></span>
                                                    </div>
                                                  </div>
                                                  <br>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                       <select class="form-control" name="condition">
                                                            ...
                                                            <option  
                                                                ...
                                                                <?php
                                                                    if($current_disease_log['condition_name'] == $diseases_set['name']){
                                                                        echo " selected ";
                                                                    }
                                                                ?>
                                                                
                                                                value="<?php echo $diseases_set['name']; ?>"><?php echo $diseases_set['name']; ?></option>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="notes" value="<?php echo $current_disease_log['note'] ?>" id="notes" placeholder="Notes"/>
                                                    </div>
                                                  </div>
